...
//    init_info.RenderPass = wd->RenderPass; // TODO: Use this when vcpkg version is upgraded
    init_info.Subpass = 0;
    ...
    ImGui_ImplVulkan_Init(&init_info, wd->RenderPass); // TODO: Only forst parameter when vcpkg version upgraded
    ...
    LambdaSnail::Todo::NoteStore note_store;

    auto note_controller = std::make_unique<LambdaSnail::Todo::Ui::NoteViewController>(std::make_unique<LambdaSnail::Todo::NoteStore>() );
